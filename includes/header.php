...
/* Online Ödeme menü vurgusu (kırmızı düğme, İletişim'in sağında). Başlık ızgarası dardır
   (düğmesiz ~1320px, tam düğmeyle ~1560px ister); bu yüzden düğme ekran genişliğine göre
   kademeli sıkışır (gerçek tarayıcıda, doğru Türkçe metinle ölçülerek belirlendi). */
...
/* Kademe 1 (≤1579px): ok korunur, boşluklar sıkılaşır */
...
/* Kademe 2 (≤1419px): ok gizlenir, yazı 12px */
