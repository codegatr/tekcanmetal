  ...
  <div class="container">
    ...
    <div class="footer-strip">
      <div class="footer-strip-brand">
        ...
        <img src="<?= h(img_url($logo)) ?>" alt="<?= h(settings('site_name', 'Tekcan Metal')) ?>" class="footer-logo" width="160" height="40" loading="lazy" decoding="async">
      </div>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <?php if (!empty($qnbOn)): ?><li><a href="<?= h(url_lang('odeme.php')) ?>" target="_blank" rel="noopener"><?= h(t('header.menu.online_payment', 'Online Ödeme')) ?></a></li><?php endif; ?>
...
<style>.site-footer{background:linear-gradient(180deg,#0c1e44 0%,#050d24 100%);color:rgba(255,255,255,.85);padding:0;font-size:13.5px;line-height:1.7;position:relative;margin-top:80px}.site-footer::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(to right,var(--accent) 0%,var(--primary) 50%,var(--accent) 100%)}.footer-strip{padding:36px 0 30px;display:grid;grid-template-columns:auto 1fr auto;gap:32px;align-items:center;border-bottom:1px solid rgba(255,255,255,.08)}@media (max-width:900px){.footer-strip{grid-template-columns:1fr;text-align:center;gap:20px}}.footer-strip-brand{display:flex;align-items:center}.footer-logo{height:54px;width:auto;filter:brightness(1.1)}@media (max-width:900px){.footer-strip-brand{justify-content:center}}.footer-strip-tagline{display:flex;flex-direction:column;gap:2px}.footer-strip-eyebrow{font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:var(--accent)}.footer-strip-slogan{font-family:Georgia,serif;font-size:20px;color:#fff;font-weight:500}.footer-strip-slogan em{font-style:italic;color:#c9a86b}.footer-strip-cta{display:flex;gap:10px}@media (max-width:900px){.footer-strip-cta{justify-content:center}}.footer-strip-btn{padding:11px 20px;font-size:11.5px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;text-decoration:none;transition:.18s;border:1px solid transparent;display:inline-flex;align-items:center;gap:6px}.footer-strip-btn-primary{background:var(--accent);color:#fff;border-color:var(--accent)}.footer-strip-btn-primary:hover{background:var(--accent-dark);transform:translateY(-1px)}.footer-strip-btn-ghost{background:transparent;color:#fff;border-color:rgba(255,255,255,.25)}.footer-strip-btn-ghost:hover{background:rgba(255,255,255,.06);border-color:#c9a86b;color:#c9a86b}.footer-grid{display:grid;grid-template-columns:1.7fr 1fr 1fr 1.5fr;gap:50px;padding:50px 0 40px;border-bottom:1px solid rgba(255,255,255,.08)}@media (max-width:900px){.footer-grid{grid-template-columns:1fr 1fr;gap:36px;padding:36px 0}}@media (max-width:600px){.footer-grid{grid-template-columns:1fr;gap:28px}}.footer-col .footer-h{font-size:11.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:#fff;margin:0 0 22px;position:relative;padding-bottom:14px}.footer-col .footer-h::after{content:'';position:absolute;bottom:0;left:0;width:32px;height:2px;background:var(--accent)}.footer-col ul{list-style:none;padding:0;margin:0}.footer-col li{margin-bottom:10px}.footer-col a{color:rgba(255,255,255,.7);text-decoration:none;font-size:13.5px;transition:.18s}.footer-col a:hover{color:#fff;padding-left:6px}.footer-about{color:rgba(255,255,255,.7);font-size:13.5px;line-height:1.75;margin:0 0 22px;max-width:380px}.footer-social{display:flex;gap:8px}.footer-social a{width:36px;height:36px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.06);color:rgba(255,255,255,.7);text-decoration:none;transition:.2s;border:1px solid transparent}.footer-social a:hover{background:var(--accent);color:#fff;border-color:var(--accent);transform:translateY(-2px);padding-left:0}.footer-contact-list{display:flex;flex-direction:column;gap:14px}.footer-contact-list li{display:grid;grid-template-columns:24px 1fr;gap:12px;align-items:start;margin:0;font-size:13px;line-height:1.55;color:rgba(255,255,255,.75)}.footer-contact-ico{color:var(--accent);font-size:14px;margin-top:2px}.footer-contact-list strong{color:#fff;font-weight:600}.footer-contact-list a{color:rgba(255,255,255,.75);display:inline-block;min-height:32px;line-height:32px;padding:2px 0}.footer-contact-list a:hover{color:#fff;padding-left:0}.footer-contact-mobile{font-size:13px;color:rgba(255,255,255,.65) !important}.footer-bottom{display:flex;justify-content:space-between;align-items:center;padding:22px 0;font-size:12px;color:rgba(255,255,255,.5);flex-wrap:wrap;gap:14px}.footer-bottom-right{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.footer-bottom a{color:rgba(255,255,255,.55);text-decoration:none;transition:.18s}.footer-bottom a:hover{color:#fff}.footer-sep{color:rgba(255,255,255,.25)}.footer-vendor{color:#c9a86b !important;font-weight:600}.footer-vendor:hover{color:var(--accent) !important}</style>
