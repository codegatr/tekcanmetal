...
-- =====================================================
-- v1.0.86 — tm_seo_iller (25 il) + tm_seo_ulkeler (4 ülke) i18n
-- ALTER kolonları zaten mevcut, sadece UPDATE eksikti
-- 25 il × 3 alan × 3 dil = 225 alan
-- 4 ülke × 2 alan × 3 dil = 24 alan
-- Toplam: 249 i18n alan çevirisi
-- =====================================================
