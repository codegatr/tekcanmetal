...
<style>.hes-page{--hp-bg:#f5f7fa;--hp-surface:#ffffff;--hp-surface-2:#fafbfd;--hp-border:#e3e8ef;--hp-border-strong:#c5cfdc;--hp-text:#0a0e1a;--hp-text-muted:#5e6470;--hp-text-dim:#8a93a3;--hp-primary:#1e4a9e;--hp-primary-dark:#143672;--hp-accent:#c8102e;--hp-accent-dark:#a00d24;--hp-success:#10803a;--hp-warning:#b45309;--hp-mono:'JetBrains Mono',ui-monospace,monospace;--hp-sans:'Inter',system-ui,sans-serif;background:var(--hp-bg);font-family:var(--hp-sans)}.hes-hero{background:linear-gradient(135deg,#050d24 0%,#0c1e44 50%,#143672 100%);color:#fff;padding:60px 0 50px;position:relative;overflow:hidden;border-bottom:3px solid var(--hp-accent)}.hes-hero::before{content:'';position:absolute;inset:0;background-image:repeating-linear-gradient(45deg,transparent 0,transparent 20px,rgba(255,255,255,.02) 20px,rgba(255,255,255,.02) 21px);pointer-events:none}.hes-hero-inner{display:grid;grid-template-columns:1fr auto;gap:30px;align-items:center;position:relative;z-index:2}@media (max-width:800px){.hes-hero-inner{grid-template-columns:1fr;text-align:center}}.hes-hero-text h1{font-family:var(--hp-sans);font-size:clamp(28px,4vw,40px);font-weight:700;letter-spacing:-.5px;margin:0 0 8px;line-height:1.15}.hes-hero-text p{font-size:14px;color:rgba(255,255,255,.65);margin:0;max-width:560px}.hes-hero-stats{display:flex;gap:32px;flex-wrap:wrap}@media (max-width:800px){.hes-hero-stats{justify-content:center}}.hes-hero-stat{text-align:left}@media (max-width:800px){.hes-hero-stat{text-align:center}}.hes-hero-stat strong{display:block;font-family:var(--hp-mono);font-size:24px;font-weight:700;color:#fff;line-height:1;margin-bottom:4px}.hes-hero-stat span{font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,.55)}.hes-main{padding:30px 0 80px}.hes-step{background:var(--hp-surface);border:1px solid var(--hp-border);margin-bottom:18px;overflow:hidden}.hes-step-head{padding:20px 28px;background:var(--hp-surface-2);border-bottom:1px solid var(--hp-border);display:flex;justify-content:space-between;align-items:center;gap:18px;flex-wrap:wrap}.hes-step-head-left{display:flex;align-items:center;gap:14px}.hes-step-num{width:32px;height:32px;background:var(--hp-primary);color:#fff;display:flex;align-items:center;justify-content:center;font-family:var(--hp-mono);font-size:14px;font-weight:700}.hes-step-head h2{margin:0;font-size:14px;font-weight:700;color:var(--hp-text);letter-spacing:.2px}.hes-step-head h2 small{display:block;font-size:11.5px;font-weight:500;color:var(--hp-text-muted);margin-top:2px;letter-spacing:0}.hes-step-body{padding:24px 28px}.hes-products{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:10px}.hes-product{background:var(--hp-surface);border:1.5px solid var(--hp-border);padding:18px 14px;text-align:center;cursor:pointer;transition:.18s;position:relative;display:flex;flex-direction:column;align-items:center;gap:10px}.hes-product:hover{border-color:var(--hp-primary);transform:translateY(-2px);box-shadow:0 6px 16px rgba(30,74,158,.1)}.hes-product.active{background:var(--hp-primary);border-color:var(--hp-primary);color:#fff}.hes-product.active::before{content:'✓';position:absolute;top:6px;right:8px;font-size:11px;font-weight:700;color:#fff;background:var(--hp-accent);width:18px;height:18px;display:flex;align-items:center;justify-content:center;border-radius:50%}.hes-product-icon{width:48px;height:48px;display:flex;align-items:center;justify-content:center;color:var(--hp-primary);transition:.2s}.hes-product.active .hes-product-icon{color:#fff}.hes-product-icon svg{width:42px;height:42px}.hes-product-name{font-size:12.5px;font-weight:600;color:var(--hp-text);line-height:1.25}.hes-product.active .hes-product-name{color:#fff}.hes-bench{display:grid;grid-template-columns:1fr 1fr;gap:0;border-bottom:1px solid var(--hp-border)}@media (max-width:900px){.hes-bench{grid-template-columns:1fr}}.hes-inputs{padding:30px 32px;border-right:1px solid var(--hp-border)}@media (max-width:900px){.hes-inputs{border-right:0;border-bottom:1px solid var(--hp-border)}}.hes-inputs-head{margin-bottom:24px}.hes-inputs-head h3{font-size:18px;font-weight:700;margin:0 0 4px;color:var(--hp-text)}.hes-inputs-head p{font-size:12.5px;color:var(--hp-text-muted);margin:0;font-family:var(--hp-mono)}.hes-fields{display:grid;grid-template-columns:1fr 1fr;gap:14px}.hes-fields.cols-1{grid-template-columns:1fr}.hes-fields.cols-3{grid-template-columns:1fr 1fr 1fr}.hes-field{display:flex;flex-direction:column;gap:5px}.hes-field-full{grid-column:1/-1}.hes-field label{font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:var(--hp-text-muted)}.hes-field-input-wrap{position:relative}.hes-field input,.hes-field select{width:100%;padding:12px 50px 12px 14px;font-family:var(--hp-mono);font-size:15px;font-weight:600;color:var(--hp-text);background:var(--hp-surface-2);border:1.5px solid var(--hp-border);transition:.15s;border-radius:0;-webkit-appearance:none;-moz-appearance:textfield}.hes-field select{padding-right:14px;font-family:var(--hp-sans);font-size:13.5px;-webkit-appearance:menulist}.hes-field input::-webkit-outer-spin-button,.hes-field input::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.hes-field input:focus,.hes-field select:focus{outline:0;border-color:var(--hp-primary);background:#fff;box-shadow:0 0 0 3px rgba(30,74,158,.12)}.hes-field-unit{position:absolute;right:14px;top:50%;transform:translateY(-50%);font-size:11px;font-weight:600;color:var(--hp-text-dim);pointer-events:none;font-family:var(--hp-mono)}.hes-presets{margin-top:18px;padding-top:18px;border-top:1px dashed var(--hp-border)}.hes-presets-label{font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:var(--hp-text-muted);margin-bottom:10px}.hes-presets-list{display:flex;flex-wrap:wrap;gap:6px}.hes-preset{padding:6px 11px;font-family:var(--hp-mono);font-size:11.5px;font-weight:600;background:var(--hp-surface-2);border:1px solid var(--hp-border);color:var(--hp-text);cursor:pointer;transition:.15s}.hes-preset:hover{background:var(--hp-primary);color:#fff;border-color:var(--hp-primary)}.hes-visual{background:var(--hp-surface-2);display:flex;flex-direction:column}.hes-diagram{background:#fff;padding:30px 32px;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:280px;position:relative;overflow:hidden}.hes-diagram::before{content:'';position:absolute;inset:0;background-image:linear-gradient(to right,rgba(30,74,158,.03) 1px,transparent 1px),linear-gradient(to bottom,rgba(30,74,158,.03) 1px,transparent 1px);background-size:20px 20px;pointer-events:none}.hes-diagram-svg{width:100%;max-width:340px;height:auto;position:relative;z-index:2}.hes-diagram-caption{margin-top:18px;font-size:11px;font-weight:600;letter-spacing:1.5px;text-transform:uppercase;color:var(--hp-text-muted);text-align:center;position:relative;z-index:2}.hes-formula{background:#0a0e1a;color:#9be4bb;padding:14px 32px;font-family:var(--hp-mono);font-size:12px;border-top:1px solid #1f2937;overflow-x:auto}.hes-formula::before{content:'⨏ ';color:#fbbf24}.hes-result{background:linear-gradient(135deg,var(--hp-primary) 0%,var(--hp-primary-dark) 100%);color:#fff;padding:22px 28px;display:grid;grid-template-columns:repeat(4,1fr) auto;gap:24px;align-items:center;position:relative;overflow:hidden}@media (max-width:900px){.hes-result{grid-template-columns:repeat(2,1fr);gap:18px}}@media (max-width:500px){.hes-result{grid-template-columns:1fr;text-align:center}}.hes-result::before{content:'';position:absolute;inset:0;background-image:radial-gradient(circle at 90% 50%,rgba(200,16,46,.2) 0%,transparent 60%);pointer-events:none}.hes-result-item{position:relative;z-index:2}.hes-result-label{font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,.6);margin-bottom:6px}.hes-result-value{font-family:var(--hp-mono);font-size:22px;font-weight:700;color:#fff;line-height:1;letter-spacing:-.3px}.hes-result-value.big{font-size:32px;color:#fbbf24}.hes-result-actions{display:flex;gap:8px;position:relative;z-index:2}@media (max-width:500px){.hes-result-actions{justify-content:center}}.hes-btn{padding:11px 18px;font-size:11.5px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;border:0;cursor:pointer;transition:.18s;text-decoration:none;display:inline-flex;align-items:center;gap:6px}.hes-btn-add{background:#fbbf24;color:#0a0e1a}.hes-btn-add:hover{background:#f59e0b;transform:translateY(-1px)}.hes-btn-quote{background:var(--hp-accent);color:#fff}.hes-btn-quote:hover{background:var(--hp-accent-dark);transform:translateY(-1px)}.hes-material{background:var(--hp-surface);padding:14px 28px;border-bottom:1px solid var(--hp-border);display:flex;align-items:center;gap:18px;flex-wrap:wrap}.hes-material-label{font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:var(--hp-text-muted)}.hes-material-pills{display:flex;gap:6px;flex-wrap:wrap}.hes-material-pill{padding:7px 14px;font-size:12px;font-weight:600;background:var(--hp-surface-2);border:1px solid var(--hp-border);color:var(--hp-text);cursor:pointer;transition:.15s;font-family:var(--hp-mono)}.hes-material-pill:hover{border-color:var(--hp-primary)}.hes-material-pill.active{background:var(--hp-primary);color:#fff;border-color:var(--hp-primary)}.hes-material-custom{display:none;align-items:center;gap:6px}.hes-material-custom.show{display:inline-flex}.hes-material-custom input{width:80px;padding:7px 8px;font-family:var(--hp-mono);font-size:12px;border:1px solid var(--hp-border-strong);background:#fff}.hes-compare{background:var(--hp-surface);border:1px solid var(--hp-border);padding:24px 28px;margin-top:18px;display:none}.hes-compare.show{display:block}.hes-compare-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:18px}.hes-compare-head h3{font-size:14px;font-weight:700;margin:0;letter-spacing:.2px}.hes-compare-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px}.hes-compare-card{padding:16px 18px;background:var(--hp-surface-2);border:1px solid var(--hp-border)}.hes-compare-card h4{font-size:12px;font-weight:600;margin:0 0 8px;color:var(--hp-text-muted)}.hes-compare-card-value{font-family:var(--hp-mono);font-size:20px;font-weight:700;color:var(--hp-text);letter-spacing:-.2px}.hes-compare-card-density{font-size:11px;color:var(--hp-text-dim);margin-top:4px;font-family:var(--hp-mono)}.hes-cost{background:#fefce8;border:1px solid #fde68a;padding:18px 24px;margin-top:18px;display:none;align-items:center;gap:18px;flex-wrap:wrap}.hes-cost.show{display:flex}.hes-cost-icon{width:42px;height:42px;background:#fbbf24;color:#0a0e1a;display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0}.hes-cost-input{display:flex;align-items:center;gap:10px;flex:1;min-width:200px}.hes-cost-input label{font-size:12px;font-weight:600;color:var(--hp-text);white-space:nowrap}.hes-cost-input input{width:120px;padding:8px 12px;font-family:var(--hp-mono);font-size:14px;font-weight:600;border:1px solid #d4a418;background:#fff}.hes-cost-result{font-family:var(--hp-mono);font-size:18px;font-weight:700;color:#92400e;margin-left:auto}.hes-cart{background:var(--hp-surface);border:1px solid var(--hp-border);margin-top:18px;display:none}.hes-cart.show{display:block}.hes-cart-head{padding:18px 28px;background:var(--hp-text);color:#fff;display:flex;justify-content:space-between;align-items:center}.hes-cart-head h3{margin:0;font-size:14px;font-weight:700;letter-spacing:.2px}.hes-cart-head span{font-family:var(--hp-mono);font-size:13px;color:#fbbf24;font-weight:700}.hes-cart-table{width:100%;border-collapse:collapse;font-size:13px}.hes-cart-table th,.hes-cart-table td{padding:12px 18px;text-align:left;border-bottom:1px solid var(--hp-border)}.hes-cart-table th{background:var(--hp-surface-2);font-size:10.5px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--hp-text-muted)}.hes-cart-table td{font-family:var(--hp-mono)}.hes-cart-table td.product{font-family:var(--hp-sans);font-weight:600}.hes-cart-table td.actions{text-align:center;width:60px}.hes-cart-rm{background:transparent;border:1px solid var(--hp-border);color:var(--hp-accent);padding:4px 10px;cursor:pointer;font-size:13px;font-weight:700}.hes-cart-rm:hover{background:var(--hp-accent);color:#fff;border-color:var(--hp-accent)}.hes-cart-foot{padding:18px 28px;background:var(--hp-surface-2);border-top:1px solid var(--hp-border);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px}.hes-cart-grand{font-family:var(--hp-mono);font-size:24px;font-weight:700;color:var(--hp-text)}.hes-cart-actions{display:flex;gap:8px;flex-wrap:wrap}.hes-fab{display:none;position:fixed;bottom:80px;right:14px;background:var(--hp-accent);color:#fff;padding:14px 20px;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;text-decoration:none;z-index:50;box-shadow:0 12px 28px rgba(200,16,46,.4);border:0;cursor:pointer}@media (max-width:768px){.hes-fab.show{display:inline-flex;align-items:center;gap:6px}}.hes-tip{background:#eff6ff;border-left:3px solid var(--hp-primary);padding:14px 18px;margin-top:14px;font-size:12.5px;color:var(--hp-text-muted);line-height:1.55}.hes-tip strong{color:var(--hp-primary)}@media print{.site-header,.site-footer,.mobile-bottomnav,.hes-fab,.hes-presets,.hes-product,.hes-product:not(.active),.hes-step-num,.hes-result-actions,.hes-cart-actions,.hes-cart-rm,.hes-material-pill:not(.active),.hes-cost{display:none !important}.hes-page{background:#fff !important}.hes-step{border:1px solid #999 !important;page-break-inside:avoid}}</style>
